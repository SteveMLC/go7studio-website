...
<HeroCallout
  eyebrow="Agent pre-flight"
  title="Correct code without a real destination is still an agent that should stay offline."
  body="The tests passed, but the publishing surface did not exist yet. Disabling the agents kept the studio from paying for convincing dry-run output with nowhere safe to land."
/>

<KeyTakeaways title="The pre-flight rule" items='[{"title":"Surface","body":"The account, page, or channel must exist before cron starts."},{"title":"Routing","body":"Approved output needs a wired destination, not a growing queue."},{"title":"Failure visibility","body":"Logs or status files have to surface breaks within a day."},{"title":"Brand readiness","body":"Passing architecture checks does not mean the voice should go live."}]' />
