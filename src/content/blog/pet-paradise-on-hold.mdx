...
tags:
  ...
  - studio
status: "draft"
seoTitle: "The Game I Won't Ship: Why Pet Paradise Is on Hold"
...
Pet Paradise is the most complete unshipped game in the studio. 814 files, 7.3MB of integrations, ~80-90% done on the systems side. Pet-breeding mutation system: functional. Visual hook: validated in playtests. Everything ready except one bottleneck — and that bottleneck is sitting between me and a category where the obvious comparable (Pet Sim X on Roblox) reportedly earns around $1M per month. Capturing 1% of that is more than everything else in the studio combined.
...
Even with conservative assumptions, Pet Paradise dominates the portfolio's theoretical upside by an order of magnitude. Honest read: if any single game in the studio earns focused attention on its own, this is the one.

That makes the freeze a real decision, not a default. "I'll get to it eventually" is not the freeze. "The unit economics of finishing it now do not work, and here are the four conditions that would change that" — that's the freeze.
...
Eighty to ninety percent on the systems side. The remaining ten to twenty isn't spread evenly — it's piled into one place, and that one place is the entire reason for the freeze.
...
Each step is solvable on its own. The chain is what's slow. Until I can drop a new pet model into Bplug and have it land in Roblox Studio with working joints in under an hour, every new pet costs me a day. The R6 hand-fix is the worst link, and it doesn't yield to automation in 2-hour daily blocks. It needs a 2-week uninterrupted block to industrialize, and that's a block I haven't had.
...
The honest math: shipping Empire's next phase first compounds harder over the next 90 days than the same time spent thawing Pet Paradise. Pet Paradise revenue is gated on a multi-month runway I don't have to spend yet — and may never need to spend, if the resume conditions don't fire.
...
Most solo-dev advice says "ship anything." That advice is wrong for category-benchmark games. Shipping Pet Paradise at 90% in a category where the top games sit at 99% is asymmetric loss — the worse experience defines the brand for everyone who tries it, and they don't come back when the better version eventually arrives.
...
The portfolio metric isn't "things shipped this quarter." It's "things ready to thaw when the gate trips, shipping when the math works." Pet Paradise will thaw when the math works. Until then, the freeze is the right call — and writing the gate down is what keeps me honest about it.
...
<div className="my-12 rounded-2xl border border-brand-teal/30 bg-brand-teal/5 p-8">
  ...
  <p className="mt-3 text-white/70">Empire Tycoon is the game that did ship — and its daily revenue is the lever that decides whether Pet Paradise thaws this year. Free to play, monetized with rewarded ads and IAPs.</p>
