...
<HeroCallout
  eyebrow="Work-order contract"
  title="A goal is not a work order until the agent can verify it without asking you what you meant."
  body="The four-line preamble turns plausible work into checkable work: objective, acceptance, files, and branching. Every line exists because the missing version already failed."
/>

<KeyTakeaways title="The four lines" items='[{"title":"Objective","body":"One present-tense outcome keeps the task from splitting into multiple plausible jobs."},{"title":"Acceptance","body":"Checkable bullets define what done means before the agent starts."},{"title":"Files","body":"Explicit paths prevent helpful adjacent edits from widening the review surface."},{"title":"Branching","body":"Legal refusal paths stop the agent from fabricating progress when the task does not apply."}]' />
