...
<KeyTakeaways items='[{"title":"Route by stage","body":"Research, drafting, critique, implementation, and final ownership are different jobs and usually deserve different defaults."},{"title":"Price is secondary to role fit","body":"Cheap and fast models are valuable early. Trusted final-owner posture matters later."},{"title":"Context boundaries are part of routing","body":"Fresh sessions, critic passes, and isolated coding threads often improve quality as much as switching models."},{"title":"Some teams should stay simpler","body":"If the workflow is tiny or the controls are weak, routing complexity can hurt more than it helps."}]' />
...
<DiagramFrame title="The routed stack I actually care about" eyebrow="Role flow">
  <TimelineSteps title="Research -> drafter -> critic -> implementer -> final owner" steps='[{"title":"Research","body":"Find the material, scan broadly, and reduce blank-page friction.","meta":"speed + breadth"},{"title":"Drafter","body":"Turn raw material into a usable first pass with structure and momentum.","meta":"speed + cost"},{"title":"Critic","body":"Challenge weak claims, missing support, and muddy framing before they harden.","meta":"skepticism"},{"title":"Implementer","body":"Move from words into code, systems, or concrete operational work.","meta":"workflow fit"},{"title":"Final owner","body":"Make the version-good-enough call with stronger judgment and clearer accountability.","meta":"trust"}]' />
</DiagramFrame>
...
Even Kimi’s current platform docs are useful in this context, not because they tell you the one true answer, but because they support thinking in terms of fast API-driven passes where cost and throughput matter. If you are considering Kimi, MiniMax, or similar vendors for research and drafting roles, pair that decision with a basic data-residency and policy check instead of treating all providers as interchangeable.
