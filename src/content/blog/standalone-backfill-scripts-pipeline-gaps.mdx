...
<HeroCallout eyebrow="Operations debt" title="A remembered script is not a pipeline step." body="The image cleanup worked only while the operator remembered it. Wiring the scripts into the DAG turned invisible manual labor into a repeatable quality gate." />

<KeyTakeaways title="The audit rule now" items='[{"title":"Manual runs are signal","body":"Any script run by hand in the last 90 days is probably doing pipeline-shaped work."},{"title":"Pipeline-or-delete","body":"If a script carries production value, wire it in; if it does not, remove it before it becomes folklore."},{"title":"Quarantine before upload","body":"Image filtering belongs before CDN upload so junk media never becomes a live asset."},{"title":"Canary before recurrence","body":"A standalone gap only closes when the wired step has a test for the original failure."}]' />
