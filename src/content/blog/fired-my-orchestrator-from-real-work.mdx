...
tags:
  ...
  - operator-design
status: "published"
seoTitle: "Why I Fired My Orchestrator Agent From Doing Real Work"
...
<HeroCallout
  ...
  title="The orchestrator's job is to preserve the system, not to be the smartest worker in it."
  body="Walt became more useful when he stopped producing artifacts directly and started routing scoped work orders to specialists with acceptance criteria attached."
/>

<KeyTakeaways title="The coordinator contract" items='[{"title":"Route first","body":"The orchestrator writes briefs, opens tabs, and assigns ownership."},{"title":"Protect context","body":"Hot-token budget is treated as an operational limit, not a comfort setting."},{"title":"Forbid silent work","body":"No production change happens without a work order and a specialist owner."},{"title":"Fire on drift","body":"Small correct artifacts from the wrong role are still failures."}]' />
