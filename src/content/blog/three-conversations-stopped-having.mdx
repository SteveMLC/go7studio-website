...
I used to say each of these at least once a week. They all sounded sensible. They were all the wrong move.
...
Nine fabricated courses shipped to production because a pipeline step returned `surviving_words=0` and the next step continued anyway. The nine courses were generated from titles and metadata alone — fluent, plausible, completely unrelated to the actual source content. They got past every model-quality check because the input itself was empty.
...
Full postmortem in [My AI Agent Wrote Nine Courses From Nothing](/blog/agent-wrote-nine-courses-from-nothing).
...
Full receipts in [The Day I Realized My AI Agents Were Lying to Each Other](/blog/agents-lying-to-each-other).
...
<div className="my-12 rounded-2xl border border-brand-teal/30 bg-brand-teal/5 p-8">
  ...
  <p className="mt-3 text-white/70">One post every couple of weeks from a one-person studio that's been catching itself in these conversations long enough to write the reframes down. Agent design, harness engineering, and the routing stack behind it all.</p>
