...
targetKeywords:
  ...
  - ship games faster
seoTitle: "We Shipped 4 Games with AI in 30 Days — Here's How"
...
<HeroCallout
  eyebrow="Sprint architecture"
  title="The multiplier was not AI replacing the developer. It was role separation around the repeatable work."
  body="The agents handled scaffolding, integrations, documentation, analytics, and batch tasks. The human kept the parts that still need taste: game feel, platform judgment, final art direction, and whether the shipped loop was worth playing."
/>

<KeyTakeaways title="What survived the sprint" items='[{"title":"Clear agent roles","body":"Strategy, engineering, and review stayed separate enough that parallel work remained usable."},{"title":"Fast feedback loops","body":"Flutter moved fastest because builds, state, and UI feedback were easy for agents to reason about."},{"title":"Human taste stayed central","body":"Economy balance, feel, and final product judgment did not become automated."},{"title":"Reusable systems compounded","body":"Ad integration, analytics, asset workflows, and deployment scripts carried into the next games."}]' />
