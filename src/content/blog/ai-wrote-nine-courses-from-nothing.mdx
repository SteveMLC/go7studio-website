...
<div className="my-12 rounded-2xl border border-brand-teal/30 bg-brand-teal/5 p-8">
  ...
  <p className="mt-3 text-white/70">One post a month from real build work: production pipelines, AI-assisted engineering workflows, review loops, and the parts of complex products that only become obvious after shipping.</p>
