...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    secondaryCtaLabel: "Meet the Studio",
    secondaryCtaHref: "/#about",
    trailerUrl: "https://youtu.be/_W9W_L2RGnE",
    screenshots: [
  ...
  {
    slug: "sortbloom",
    title: "Sortbloom - Zen Block Puzzle",
    thumbnail: "/images/games/sortbloom/icon.png",
    tagline: "Sort blocks. Watch your garden bloom. Find your zen.",
    description:
      "A meditative block-sorting puzzle where your zen garden grows with every solve. No timers, no pressure—just peace.",
    longDescription:
      "Sortbloom is a zen puzzle game where you sort colored blocks into stacks—simple to learn, deeply satisfying to master.\n\nEvery puzzle you solve nurtures your personal zen garden. Watch it evolve from bare stones to a lush paradise as you progress through 25 ranks of mastery, from Seedling to Summit.\n\nFour difficulty levels from Easy to Ultra, special blocks that challenge your strategy, and a progression system with 48 achievements to unlock. No ads interrupting your flow. No timers. Just puzzles, peace, and your garden.",
    features: [
      "Meditative block-sorting puzzles across 4 difficulty levels",
      "Living zen garden that grows and evolves with your progress",
      "25 ranks from Seedling to Summit",
      "48 achievements across mastery, speed, streaks, and more",
      "Special blocks: locked and frozen challenges",
      "No intrusive ads or timers — play at your own peaceful pace",
    ],
    status: "released",
    platforms: ["android"],
    primaryCtaLabel: "Get it on Google Play",
    primaryCtaHref: "https://play.google.com/store/apps/details?id=com.go7studio.stakd",
    secondaryCtaLabel: "Visit Sortbloom.com",
    secondaryCtaHref: "https://sortbloom.com",
    keywords: ["puzzle game", "zen game", "block sorting", "relaxing puzzle", "meditation game", "android game", "zen garden"],
  },
];
