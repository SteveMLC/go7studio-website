...
export const GAMES: Game[] = [
  {
    ...
    description:
      "Start small and think big—build multiple businesses, upgrade profits, and watch your empire spread.",
    longDescription:
    ...
    primaryCtaHref: "https://play.google.com/store",
  ...
  },
  {
    ...
    status: "coming-soon",
    platforms: ["roblox"],
    primaryCtaLabel: "Notify Me When SlimeSlip Launches",
  ...
  },
  {
    ...
    status: "coming-soon",
    platforms: ["roblox"],
    primaryCtaLabel: "Notify Me When Pet Paradise Drops",
    primaryCtaHref: "/#about",
    secondaryCtaLabel: "Explore other games",
    secondaryCtaHref: "/games",
  },
